...
class Notebook:
    ...
    def search(self, myfilter):
        """Find all notes that match the given filter string."""
        return [note for note in self.notes if note.match(myfilter)]
